...
Define provider-selected metadata and query execution behind the Database Agent. The default provider is zorth-web-sql-service over HTTP. JDBC remains a local and test adapter.
