...
Define deterministic Mapper scanning, per-file structured extraction, validation, output mapping, atomic persistence, retry boundaries, failure isolation, and generation reports.
