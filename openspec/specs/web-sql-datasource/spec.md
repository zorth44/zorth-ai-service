...
Define the HTTP adapter that routes Database Agent metadata and read-only query execution to zorth-web-sql-service, including token forwarding, allowlist, result conversion, and remote error mapping.
