# Mapper Semantic Operations

## Purpose

Define opt-in configuration, the manual generation trigger, single-batch concurrency behavior, safe observability, and offline versus real-model verification for Mapper semantic generation.
